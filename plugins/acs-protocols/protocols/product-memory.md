...
Human review and derived companions follow [Presenter](presenter.md), including version-scoped decisions, deduplication and retrievable reviewed content. The rules below preserve the canonical HTML reading format rather than creating a separate fact source.
