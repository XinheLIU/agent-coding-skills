...
| Template | Use when |
| --- | --- |
| [Visual report](../resources/skills-src/authoring/references/visual-report.md) | The default derived HTML companion: header, overview, finding cards, evidence, footer |
| [Tabbed discovery report](../resources/skills-src/authoring/references/tabbed-discovery-report.md) | Complex multi-dimensional analysis: 3+ major concerns, revision history, nested options, multi-dimension before/after |
