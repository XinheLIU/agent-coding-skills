...
| --- | --- | --- | --- |
| **Why** | `<product-docs>/<product-slug>/product.html` | Product intent: personas, problems, capabilities, journeys, scope. See [product-memory.md](../../../../../protocols/product-memory.md). | Product skills. When no product docs exist, `acs-map-current-product` infers the baseline from the repo. |
