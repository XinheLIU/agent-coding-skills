...
3. Recheck ticket/input revisions and acquire its exclusive claim through the coordinator. Execute with [`acs-tdd`](../acs-tdd/SKILL.md) (reference procedure; capability not installed), serially as the active agent or through authorized delegation with its criteria and prerequisite evidence.
