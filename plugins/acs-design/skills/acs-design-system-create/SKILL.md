...
Create the canonical design authority that grounds all design work in this project: `DESIGN.md` at the project root — the **how** of the shared design triad ([../../protocols/design-memory.md](../../protocols/design-memory.md)).
