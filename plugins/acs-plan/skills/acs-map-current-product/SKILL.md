...
List gaps and next-product questions without scoping them. Use this vocabulary so `acs-define-outcomes` can consume it directly:
...
If an improvement is already requested, hand off to `acs-define-outcomes` after the baseline exists.
