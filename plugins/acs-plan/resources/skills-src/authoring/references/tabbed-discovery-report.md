...
- [visual-report.md](../../../../skills/acs-map-current-product/references/visual-report.md) — Card-based reports, inline SVG patterns
- [html-report.md](../../../../skills/acs-map-current-product/references/html-report.md) — Progressive disclosure for product mapping
