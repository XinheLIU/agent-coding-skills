...
[PROTOCOL.md](../../acs-init-context/references/PROTOCOL.md#two-memories-and-a-presenter) defines Working/Persistent Memory and Presenter. This guide maps artifact roles to homes; it does not define another layer system. Preserve configured paths and formats.
