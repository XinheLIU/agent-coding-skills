...
Both UX and technical branches may run for the same effort. Every design skill can read the product document resolved through `docs/agents/memory.md` and the configured run recovery entry. Each skill also runs standalone.
