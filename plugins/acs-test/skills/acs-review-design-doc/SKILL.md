...
Not a coverage audit (that's `acs-review-code-quality`'s job). Just: does the plan specify what will be tested and how?
...
1. **Header** — canonical change/task, plan/spec/contract references and consumed revisions, source baseline, Last updated date, reviewer: acs-review-design-doc
