...
UX design turns PRD intent into implemented components. Shared design understanding is a **triad** (contract: [Design memory](../../context/acs-init-context/references/design-memory.md), symlinked into each skill's `references/`):
