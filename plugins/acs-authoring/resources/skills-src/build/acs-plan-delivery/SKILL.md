...
If scope itself is unsettled, return that question to Product. Use [acs-explore-unknowns](../../plan/acs-explore-unknowns/SKILL.md) (reference procedure; capability not installed) when broad uncertainty needs investigation; reuse its existing decision tickets rather than creating a second decision backlog.
