...
If the user asks "review my PR", redirect to `acs-review-code-quality`. If they ask "are my tests good before we refactor / before we ship the legacy rewrite / generally", you are the right tool.
