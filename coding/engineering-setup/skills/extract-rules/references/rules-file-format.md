...
- For cross-runtime parity: also surface the rule in `AGENTS.md`. The symlink pattern (`.codex/rules → ../.claude/rules`) is `review-agent-md`'s territory — recommend invoking that skill if cross-runtime support is needed.
