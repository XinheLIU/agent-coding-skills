...
description: Onboard engineers to a codebase by generating tailored documentation. Creates READMEs, ER diagrams, API references, C4 diagrams, module dependency charts, and entry-point traces. Reuses existing SVGs and aligns with project conventions.
---
