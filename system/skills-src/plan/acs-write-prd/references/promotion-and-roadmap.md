...
This is the workflow `acs-write-prd` follows when consolidating durable knowledge into `product.html`. Record semantics, vocabularies, and authority rules live in [the product memory contract](product-memory.md); this reference sequences the work.
