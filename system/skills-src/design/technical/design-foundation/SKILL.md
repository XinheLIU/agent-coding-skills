...
For each capability record consumers, scenarios, public types, configuration, lifecycle, errors, ordering, observability, private internals, supported variation, and a real consumer verification path. Add compatibility, versioning, and distribution only for independently published artifacts.
