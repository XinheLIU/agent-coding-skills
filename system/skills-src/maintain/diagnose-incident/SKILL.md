...
Remove temporary instrumentation, record the confirmed cause and verification, return routing updates to the coordinator, and route architectural seam failures to `audit-architecture`. Do not commit unless asked.
