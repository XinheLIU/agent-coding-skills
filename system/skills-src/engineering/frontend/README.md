...
This category previously vendored two external skill copies (`frontend-design`, `frontend-design-antigravity`). They were removed: this repo keeps only user-authored skills and orchestrations. External frontend design skills are catalogued in `design/ux/external-skills.md` (layer ①) and installed per their own repos — Anthropic's `frontend-design` at [anthropics/skills](https://github.com/anthropics/skills) is the layer-① reference.
