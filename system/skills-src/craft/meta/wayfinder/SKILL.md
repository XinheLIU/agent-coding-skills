...
The map is complete when no in-scope open decision remains. Hand canonical decision/requirement references and consumed revisions to `spec`; implementation requires a separate request or an explicit scope change.
