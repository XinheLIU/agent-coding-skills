...
- [Testing](testing.md) — choose seams, execute TDD, and audit test gaps.
- [Debugging](debugging.md) — build a red-capable feedback loop, diagnose, fix, and retain the regression test.
