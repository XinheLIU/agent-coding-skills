...
<div align="center">
  ...
  <a href="../README.md">Architecture Design</a> &bull;
...
This folder defines a complete technical review system with two complementary skills and a subagent fleet. `review-architecture` judges system design and decisions. `review-code-quality` judges implementation quality and production readiness. Together they are mutually exclusive in scope and collectively exhaustive in coverage.
...
- Sequence: `brainstorm` (when needed) -> `spec` -> `plan` -> `tasks` (tests required).
...
- Skills: `architecture-design/code-review/skills/review-architecture/SKILL.md`, `architecture-design/code-review/skills/review-code-quality/SKILL.md`
- Subagents: `architecture-design/code-review/agents/`
